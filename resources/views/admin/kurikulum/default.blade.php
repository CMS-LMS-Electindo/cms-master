                      ...
                      <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="..." name="kode_kurikulum" id="kode_kurikulum">
                          </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-6">
                          <div class="form-group">
                            <label class="control-label" for="nama_kurikulum">Nama Kurikulum<span class="text-danger">*</span></label>
                            <input type="text" class="form-control"  placeholder="..." name="nama_kurikulum" id="nama_kurikulum">
                          </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            <label class="control-label" for="tahun">Tahun  <span class="text-danger">*</span></label>
                            <input type="number" class="form-control"  placeholder="..." name="tahun" id="tahun">
                          </div>
                        </div>
                      </div>
                    </div>
...
<script>
  ...
  function edit(id) {
    ...
    var form = $('#formI');
        form.find('.invalid-feedback').remove();
        form.find('.form-control').removeClass('is-invalid');
    $.get("{{ url('kurikulum') }}" +'/' + id +'/edit', function (data) {
        $('#input').modal('show');
        $('#inputTitle').html('Ubah '+title);
        $('#kode_kurikulum').val(data.kode_kurikulum);
