                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6">
                          <div class="form-group">
                            <label for="jurusan" class="control-label">Jurusan <span class="text-danger">*</span></label>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6">
                          <div class="form-group">
                            <label class="control-label" for="kode_prodi">Kode Program Studi <span class="text-danger">*</span></label>
                            <input type="text" class="form-control"  placeholder="..." name="kode_prodi" id="kode_prodi">
                          </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-6">
                          <div class="form-group">
                            <label class="control-label" for="nama_prodi">Nama Program Studi<span class="text-danger">*</span></label>
                            <input type="text" class="form-control"  placeholder="..." name="nama_prodi" id="nama_prodi">
                          </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-6">
                          <div class="form-group">
                            <label class="control-label" for="inisial">Nama Inisial Program Studi<span class="text-danger">*</span></label>
                            <input type="text" class="form-control"  placeholder="..." name="inisial" id="inisial">
                          </div>
                        </div>
                        
                        <div class="col-sm-12 col-md-12 col-lg-6">
                          <div class="form-group">
                            <label class="control-label" for="kaprodi">Ketua Program Studi  <span class="text-danger">*</span></label>
                            <input type="text" class="form-control"  placeholder="..." name="kaprodi" id="kaprodi">
                          </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-6">
                          <div class="form-group">
...
<script>
  ...
  function edit(id) {
    ...
    var form = $('#formI');
        form.find('.invalid-feedback').remove();
        form.find('.form-control').removeClass('is-invalid');
    $.get("{{ url('program-studi') }}" +'/' + id +'/edit', function (data) {
        $('#input').modal('show');
