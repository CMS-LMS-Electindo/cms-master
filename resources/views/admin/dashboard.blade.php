...
@section('content')
  ...
  <!--begin::Post-->
<div class="card mb-5 mb-xl-5 m-5">
       <!--begin::Notice-->
        ...
        <div class="card-body ">
            <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6">
                ...
                <div class="d-flex flex-stack flex-grow-1">
                    <!--begin::Content-->
                    <div class="fw-bold">
                        <h4 class="text-gray-900 fw-bolder">Selamat Datang!</h4>
                        <div class="fs-6 text-gray-700">Di {{session('namaApp')}}
                            <a class="fw-bolder" href=".{{session('domainPT')}}">{{session('namaPT')}}</a>.</div>
                    </div>
                    <!--end::Content-->
                </div>
                <!--end::Wrapper-->
    ...
    <div class="col-xl-3 mb-3 px-0">
        ...
        <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">56</div>
                <div class="fw-bold text-gray-400">Jumlah Kelas MK yang telah dibuat</div>
            </div>
            <!--end::Body-->
        </a>
