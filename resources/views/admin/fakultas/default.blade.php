                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="..." name="kode_fakultas" id="kode_fakultas">
                          </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            <label class="control-label" for="nama_fakultas">Nama Fakultas<span class="text-danger">*</span></label>
                            <input type="text" class="form-control"  placeholder="..." name="nama_fakultas" id="nama_fakultas">
                          </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-6">
                          <div class="form-group">
                            <label class="control-label" for="dekan">Dekan  <span class="text-danger">*</span></label>
                            <input type="text" class="form-control"  placeholder="..." name="dekan" id="dekan">
                          </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-6">
                          <div class="form-group">
...
<script>
  ...
  function edit(id) {
    ...
    var form = $('#formI');
        form.find('.invalid-feedback').remove();
        form.find('.form-control').removeClass('is-invalid');
    $.get("{{ url('fakultas') }}" +'/' + id +'/edit', function (data) {
        $('#input').modal('show');
