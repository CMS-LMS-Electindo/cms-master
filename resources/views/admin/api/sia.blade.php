    ...
    <div class="row g-5 g-xl-8 mx-5">
        ...
        <div class="card card-xl-stretch mb-xl-8">
          ...
          <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
              <span class="card-label fw-bolder text-dark">API SIA Testing</span>
            ...
            <div class="card-toolbar">
              ...
              <!--begin::Menu 1-->
              <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6220ee32ed9e5">
                <!--begin::Header-->
                <div class="px-7 py-5">
                ...
                <div class="px-7 py-5">
                  ...
                  <div class="mb-10">
                    ...
                    <!--begin::Input-->
                    <div>
                      <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6220ee32ed9e5" data-allow-clear="true">
                        <option></option>
          ...
          <div class="card-body pt-5">
            ...
            <div class="d-flex align-items-center mb-7">
              ...
              <div class="d-flex flex-column">
                <a href="#" class="text-dark text-hover-primary fs-6 fw-bolder" onclick="apiConn('fakultas')">API Get Fakultas</a>
            ...
            <div class="d-flex align-items-center mb-7">
              ...
              <!--begin::Text-->
              <div class="d-flex flex-column">
                <a href="#"  class="text-dark text-hover-primary fs-6 fw-bolder"  onclick="apiConn('prodi')">API Get Prodi</a>
            ...
            <div class="d-flex align-items-center mb-7">
              ...
              <!--begin::Text-->
              <div class="d-flex flex-column">
                <a href="#"  class="text-dark text-hover-primary fs-6 fw-bolder" onclick="apiConn('mk-semster')">API Get MK Semester</a>
              </div>
              <!--end::Text-->
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex align-items-center mb-7">
              ...
              <!--begin::Text-->
              <div class="d-flex flex-column">
                <a href="#"  class="text-dark text-hover-primary fs-6 fw-bolder">API Get Prodi</a>
              </div>
              <!--end::Text-->
            </div>
            <!--end::Item-->
      ...
      <div class="col-xl-12 ">
        ...
        <div class="card card-xl-stretch mb-xl-8">
          ...
          <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
              <span class="card-label fw-bolder text-dark">Result</span>
              {{-- <span class="text-muted mt-1 fw-bold fs-7">Pending 10 tasks</span> --}}
            </h3>
          </div>
          <div class="card-body pt-0">
            <code id="resultJson" class="w-100"></code>
          </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  function apiConn(type,mk=null,kur=null,prodi=null) {
    Swal.fire({
        title: 'Apakah anda yakin akan mengambil data ini?',
        text: "",
        icon: 'warning',
