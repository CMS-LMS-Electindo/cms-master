                      ...
                      <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="..." name="kode_universitas" id="kode_universitas">
                          </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-6">
                          <div class="form-group">
                            <label class="control-label" for="nama_universitas">Nama Universitas<span class="text-danger">*</span></label>
                            <input type="text" class="form-control"  placeholder="..." name="nama_universitas" id="nama_universitas">
                          </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
                            <label class="control-label" for="rektor">Rektor  <span class="text-danger">*</span></label>
                            <input type="text" class="form-control"  placeholder="..." name="rektor" id="rektor">
                          </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group">
...
<script>
  ...
  function getdata(){
    ...
    var table = $('#tabel').DataTable({
      ...
      columns: [
          ...
          {data: 'kode_universitas', name: 'kode_universitas'},
          {data: 'nama_universitas', name: 'nama_universitas'},
          {data: 'rektor1', name: 'rektor1',},
  ...
  function edit(id) {
    ...
    var form = $('#formI');
        form.find('.invalid-feedback').remove();
        form.find('.form-control').removeClass('is-invalid');
    $.get("{{ url('universitas') }}" +'/' + id +'/edit', function (data) {
        $('#input').modal('show');
        $('#inputTitle').html('Ubah '+title);
        $('#kode_universitas').val(data.kode_universitas);
        $('#nama_universitas').val(data.nama_universitas);
        $('#rektor').val(data.rektor);
        $('#nip').val(data.nip);
    })
  }
  function hapus(id) {
