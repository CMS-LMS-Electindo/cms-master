...
switch ($request) {
    case '/' :
        ...
        break;
    case '/api_cms_umpar/apicms.php/cms-all-fakultas' :
        ...
        break;
    case '/api_cms_umpar/apicms.php/cms-all-prodi' :
        $testObject = new Apisia();
        if (isset($_GET['h']) &&  isset($_GET['app']))
        ...
        echo json_encode($data);
        break;
    case '/api_cms_umpar/apicms.php/cms-all-dosen' :
        $testObject = new Apisia();
        if (isset($_GET['h']) &&  isset($_GET['app']))
        ...
        echo json_encode($data);
        break;
    case '/api_cms_umpar/apicms.php/cms-all-mahasiswa' :
        $testObject = new Apisia();
        if (isset($_GET['h']) &&  isset($_GET['app']))
        ...
        echo json_encode($data);
        break;
    case '/api_cms_umpar/apicms.php/cms-dosen-mk-semester' :
        $testObject = new Apisia();
        if (isset($_GET['h']) &&  isset($_GET['app']))
        ...
        echo json_encode($data);
        break;
    case '/api_cms_umpar/apicms.php/cms-dosen-per-mk-semester' :
        $testObject = new Apisia();
        if (isset($_GET['h']) &&  isset($_GET['app']))
        ...
        echo json_encode($data);
        break;
    case '/api_cms_umpar/apicms.php/cms-mahasiswa-per-mk-semester' :
        $testObject = new Apisia();
        if (isset($_GET['h']) &&  isset($_GET['app']))
    ...
    case '/api_cms_umpar/apicms.php/cms-login' :
        $testObject = new Apisia();
        if (isset($_GET['h']) &&  isset($_GET['app']))
    ...
    case '/api_cms_umpar/apicms.php/cms-mahasiswa-mk-semester' :
        $testObject = new Apisia();
        if (isset($_GET['h']) &&  isset($_GET['app']))
        ...
        echo json_encode($data);
        break;
    case '/api_cms_umpar/apicms.php/cms-detail-mk' :
        $testObject = new Apisia();
        if (isset($_GET['h']) &&  isset($_GET['app']))
...
class Apisia{
	var $host = "192.168.24.2";
	var $username = "usrapi";
	var $password = "sabhar2014";
	var $database = "dbumpar";
	var $koneksi = "";
    ...
    public function dataDosenMKSemester($header, $app)
    {
        ...
        if ($proses == 1) {
            ...
            if (isset($_POST['nidn'])){
                $cek=mysqli_query($this->koneksi,"SELECT b.KdProdi as kode_prodi, c.Prodi as nama_prodi, a.KdKonsentrasi as kode_kurikulum, a.KdMK as kode_mk, b.Matakuliah as nama_mk, a.Kelas as kode_kelas, a.KdDosen as nidn,c.KdUnit as kode_fakultas
                FROM makuldosen a
    ...
    public function dataMahasiswaPerMKSemester($header, $app)
    {
        ...
        $group = " GROUP BY  a.NIM ORDER BY c.Kelas ASC";
        if ($sem == "1")
            $semester = "Gasal";
        else
            $semester = "Genap";
        ...
        if ($proses == 1) {
            ...
            a.NIM as kode_mahasiswa, c.Nama as nama_mahasiswa, c.KdProdi as kode_prodi, c.KdFak as kode_fakultas, c.Kelas as kode_kelas, '' as email
            FROM nilai a
            JOIN mahasiswa c
                ON a.NIM = c.NIM
            JOIN matakuliah b
